...
2. What is an event?
An action by the user (ie keystrokes, mouseover, clicking etc)

3. What is an event listener?
An event listener is a method that fires when an event happens

4. Why would we convert a NodeList into an Array?
To have access to array methods
